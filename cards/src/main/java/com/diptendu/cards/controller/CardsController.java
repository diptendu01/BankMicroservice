package com.diptendu.cards.controller;

import com.diptendu.cards.constants.CardsConstants;
import com.diptendu.cards.dto.CardsContactInfoDto;
import com.diptendu.cards.dto.CardsDto;
import com.diptendu.cards.dto.ErrorResponseDto;
import com.diptendu.cards.dto.ResponseDto;
import com.diptendu.cards.service.ICardsService;
...
@Tag(name = "CRUD REST APIs for Cards in Diptendu", description = "CRUD REST APIs in Diptendu to CREATE, UPDATE, FETCH AND DELETE card details")
@RestController
...
public class CardsController {
        ...
        @Operation(summary = "Create Card REST API", description = "REST API to create new Card inside Diptendu")
        @ApiResponses({

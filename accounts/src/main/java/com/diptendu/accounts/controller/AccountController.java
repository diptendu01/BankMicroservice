...
import com.diptendu.accounts.constants.AccountsConstants;
import com.diptendu.accounts.dto.AccountsContactInfoDto;
import com.diptendu.accounts.dto.CustomerDto;
import com.diptendu.accounts.dto.ErrorResponseDto;
import com.diptendu.accounts.dto.ResponseDto;
import com.diptendu.accounts.service.IAccountsService;
...
@Tag(name = "CRUDE REST APIs for Accounts in Diptendu", description = "CRUDE REST APIs in Diptendu to CREATE,UPDATE,FETCH AND DELETE account details")
@RestController
...
public class AccountController {
        ...
        @Operation(summary = "Create Account REST Api", description = "REST API to create new user and account ")
        @ApiResponses({
